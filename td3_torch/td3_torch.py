...
class Agent:
    ...
    def learn(self):
        ...
        # Default actor loss for cases when actor update does not occur
        actor_loss = 0.0
        ...
        # Debug outputs
        # print(f"Critic Loss: {critic_loss.item() if critic_loss is not None else 'None'}, Actor Loss: {actor_loss.item() if actor_loss is not None else 'None'}")
